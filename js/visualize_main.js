...
function exportarExcel() {
    ...
    titulo = "HGZ01_IAAS_"+messs+"_"+fechaFormateada+".xlsx";
    // -- 
...
async function getData(dates) {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbw9zLdw9rF2ZpYK44sEudhgogGmm_nx3gRrqTykCVjj_swV5u71MllahyOihzNNm1dblQ/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
